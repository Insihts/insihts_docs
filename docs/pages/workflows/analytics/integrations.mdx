...
Insihts Workflows automatically tracks how users interact with your workflows to help you better understand user engagement with your product. If the built-in [insights](/analytics/workflow-insights) are not enough, you can easily integrate with almost any analytics tool to get the full picture of your users' behavior.
