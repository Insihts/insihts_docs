---
title: Workflow Targeting
description: Filter the users that should see a specific workflow.
---
...
<Callout variant="warning">
  For targeting to work, you need to set up the user properties in the `init` function. [Learn more](/getting-started/identify-users#adding-user-properties)
</Callout>
